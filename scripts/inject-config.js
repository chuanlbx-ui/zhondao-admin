...
// 从环境变量读取配置
const apiBase = process.env.API_BASE || process.env.VITE_API_BASE_URL || 'https://zd-api.wenbita.cn';
const adminUrl = process.env.ADMIN_URL || process.env.VITE_ADMIN_URL || 'https://zd-admin.wenbita.cn';
...
console.log('✅ Admin Runtime configuration injected successfully:');
...
console.log('   API_BASE=https://your-api.com ADMIN_URL=https://your-admin.com npm run deploy');
